    ...
    <div className='mt-60'>
      ...
      <div className='grid justify-center'>
        ...
        <div className='relative w-[800px] bg-slate-800 shadow-[6px_6px_10px_-1px_rgba(0,0,0,0.3),-6px_-6px_10px_-1px_rgba(255,255,255,0.3)] rounded-xl m-[15px]'>
          <input className='absolute peer opacity-0' type="checkbox" id='input' />
          <label className='font-bold tracking-[1px] mx-[20px] h-[50px] flex items-center text-white' htmlFor="input">What is the Yakai Ecosystem?</label>
        ...
        <div className='relative w-[800px] bg-slate-800 shadow-[6px_6px_10px_-1px_rgba(0,0,0,0.3),-6px_-6px_10px_-1px_rgba(255,255,255,0.3)] rounded-xl m-[15px]'>
          ...
          <label className='font-bold tracking-[1px] mx-[20px] h-[50px] flex items-center text-white' htmlFor="input1">What are the benefits of investing in Yakai Baku?</label>
          <div className='absolute top-[15px] right-[30px] rotate-0 peer-checked:rotate-45 duration-300'>
            <img src={plus} className='h-7 w-7' alt="" />
          </div>
        ...
        <div className='relative w-[800px] bg-slate-800 shadow-[6px_6px_10px_-1px_rgba(0,0,0,0.3),-6px_-6px_10px_-1px_rgba(255,255,255,0.3)] rounded-xl m-[15px]'>
          ...
          <label className='font-bold tracking-[1px] mx-[20px] h-[50px] flex items-center text-white' htmlFor="input2">What is the role of Yakai Boom in the ecosystem?</label>
          <div className='absolute top-[15px] right-[30px] rotate-0 peer-checked:rotate-45 duration-300'>
            <img src={plus} className='h-7 w-7' alt="" />
          </div>
        ...
        <div className='relative w-[800px] bg-slate-800 shadow-[6px_6px_10px_-1px_rgba(0,0,0,0.3),-6px_-6px_10px_-1px_rgba(255,255,255,0.3)] rounded-xl m-[15px]'>
          ...
          <label className='font-bold tracking-[1px] mx-[20px] h-[50px] flex items-center text-white' htmlFor="input3">How can I participate in the Yakai Ecosystem's governance?</label>
          <div className='absolute top-[15px] right-[30px] rotate-0 peer-checked:rotate-45 duration-300'>
            <img src={plus} className='h-7 w-7' alt="" />
          </div>
        ...
        <div className='relative w-[800px] bg-slate-800 shadow-[6px_6px_10px_-1px_rgba(0,0,0,0.3),-6px_-6px_10px_-1px_rgba(255,255,255,0.3)] rounded-xl m-[15px]'>
          ...
          <label className='font-bold tracking-[1px] mx-[20px] h-[50px] flex items-center text-white' htmlFor="input4">Is the Yakai Ecosystem secure?</label>
          <div className='absolute top-[15px] right-[30px] rotate-0 peer-checked:rotate-45 duration-300'>
            <img src={plus} className='h-7 w-7' alt="" />
          </div>
